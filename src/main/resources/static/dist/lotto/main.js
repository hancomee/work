...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(5), __webpack_require__(10)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, array_1, _ajax_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Lotto = /** @class */ (function () {
        function Lotto(v) {
            ...
            for (var p in v)
                this[p] = v[p];
            this.nums = [v.num1, v.num2, v.num3, v.num4, v.num5, v.num6];
    ...
    exports.Lotto = Lotto;
    (function (Lotto) {
        var _array45 = (function (n) {
            var r = [];
            while (n-- > 0)
                r[n] = 0;
            return r;
        })(45);
        Lotto.nTable = _nTable;
        function array45() {
            return _array45.slice();
        }
        Lotto.array45 = array45;
        // 1...45
        Lotto.loop = (function (v) {
            return function (h) {
                for (var i = 1; i < v; i++)
                    h(i);
            };
        ...
        function $data() {
            return _ajax_1.$get('/lotto/values').then(function (v) { return v.reverse(); });
        }
        Lotto.$data = $data;
        function $list() {
            return $data().then(function (v) { return v.map(function (a) { return new Lotto(a); }); });
        }
        Lotto.$list = $list;
    })(Lotto = exports.Lotto || (exports.Lotto = {}));
    exports.Lotto = Lotto;
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(8), __webpack_require__(9), __webpack_require__(20)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, selector_1, replaceHTML_1, lotto_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var loop = lotto_1.Lotto.loop;
    function radioBtns(ele, handler) {
        var values = [], eles = selector_1.querySelectorAll(ele, '[data-for]', function (e, i, r) {
            r[i] = e;
        ...
        ele.addEventListener('click', function (e) {
            ...
            if (target.hasAttribute('data-for')) {
                if (!target.classList.contains('active')) {
                    var attrVal_1 = target.getAttribute('data-for');
                    ...
                    handler(attrVal_1, values.filter(function (v) { return v !== attrVal_1; }));
                }
            }
        });
    }
    var LottoE = /** @class */ (function (_super) {
        __extends(LottoE, _super);
        function LottoE() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        LottoE.prototype.disabled = function () {
            this.element.classList.add('disabled');
            return this;
        };
        LottoE.prototype.active = function () {
            this.element.classList.remove('disabled');
            return this;
        };
        return LottoE;
    }(lotto_1.Lotto));
    var $data, display = selector_1.getElementById('display'), main = selector_1.getElementsByTagName('main', 0), nav = selector_1.getElementsByTagName('nav', 0), aside = selector_1.getElementsByTagName('aside', 0), t_selector = replaceHTML_1._compile(selector_1.getElementById('selector-template').innerText), t_items = replaceHTML_1._compile(selector_1.getElementById('item-template').innerText), t_graph = replaceHTML_1._compile(selector_1.getElementById('nums-template').innerText), e_selector = selector_1.getElementsByClassName('selector', 0), e_graph = selector_1.getElementsByClassName('nums-graph', 0), c_graphs, logic = {
        select: function (n) {
            if (n && n.length) {
    ...
    function $init(data) {
        logic.init(data);
        // aside 선택부분
        e_selector.innerHTML = t_selector(lotto_1.Lotto.nTable);
        var type = 'number', selectArray = [], selNum, reset = selector_1.getElementsByClassName(aside, 'reset', 0), sels = selector_1.getElementsByAttr(e_selector, 'data-num'), handlers = {
            select: function () {
                if (type === 'number')
                    logic.select([selNum]);
                else
            ...
            reset: function () {
                ...
                selNum = null;
                $data.forEach(function (v) { return v.active(); });
                loop(function (i) { return sels[i].classList.remove('select', 'active'); });
            },
        ...
        radioBtns(selector_1.getElementsByClassName(aside, 'radio-btns', 0), function (n, not) {
            type = n;
            handlers.select();
        });
        ...
        // nav이벤트
        var classList = display.classList;
        radioBtns(selector_1.getElementsByClassName(nav, 'radio-btns', 0), function (n, not) {
            classList.remove.apply(classList, not);
            classList.add(n);
        });
    }
    lotto_1.Lotto.$data().then(function (v) { return $init(v.map(function (a) { return new LottoE(a); })); });
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
