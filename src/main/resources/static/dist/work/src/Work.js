...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(3), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, datetime_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function $get(url) {
    ...
    (function (Work) {
        ...
        Work.list = list;
        function updateText(val, work) {
            return $post('/work/db/text/' + work.id, val).then(function () { return work.text = val.text; });
        }
        Work.updateText = updateText;
        // 전체 로딩
