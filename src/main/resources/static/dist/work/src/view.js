...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(3), __webpack_require__(19), __webpack_require__(4), __webpack_require__(26), __webpack_require__(16)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, number_1, remap_1, datetime_1, inputs_1, calendar_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(11), __webpack_require__(14), __webpack_require__(7), __webpack_require__(5), __webpack_require__(17), __webpack_require__(6), __webpack_require__(24), __webpack_require__(1), __webpack_require__(25), __webpack_require__(0), __webpack_require__(20)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, genericModule_1, Work_1, location_1, html_1, events_1, dom_1, Watcher_1, array_1, FormValid_1, core_1, Forms_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var className = dom_1.DOM.className;
    ...
    var View = /** @class */ (function (_super) {
        ...
        View.prototype.$init = function (container, frag, templates) {
            ...
            // ****************************** ▼ 제목 부분 ▼ ****************************** //
            watcher.__$map = selectAll(frag.querySelector('#title'), ['{data-name}', '.dropdown-menu li[]', '.state .value'], function (title, texts, dropdowns, sVal) {
                // 제목부분 state 표기
            ...
            // ****************************** ▼ 합계 및 견적 ▼ ****************************** //
            watcher.__$map = selectAll(frag.querySelector('#sum'), ['.work-text', '.work-text textarea'], function (f, text, textarea) {
                var $text = {
                    modify: function () {
            ...
            // ****************************** ▼ 거래처 정보 ▼ ****************************** //
            watcher.__$map = selectAll(templates.customerTable, ['.panel', 'table', '[name][]', '{data-name}', '{name}'], function (self, panel, table, a, spans, inputs) {
                var $customer, ctrl = {
                    data: function (obj) {
                        $customer = obj;
                        spans.setText(obj);
            ...
            // ****************************** ▼ 작업 아이템 ▼ ****************************** //
            watcher.__$map = selectAll(templates.itemTable, ['tbody'], function (container, tbody, itemTemplate, $con, texts) {
            ...
            // ****************************** ▼ 작업 메모 ▼ ****************************** //
            watcher.__$map = selectAll(frag.querySelector('#work-memo'), ['.list', '.form', '.form textarea', '.form span'], function (container, list, createForm, createText, createBtn) {
            ...
            // ****************************** ▼ 작업 파일 ▼ ****************************** //
            watcher.__$map = selectAll(frag.querySelector('#work-ref'), ['.body', '.add-input'], function (con, body, fileInput) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(19), __webpack_require__(3), __webpack_require__(20)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, remap_1, number_1, Forms_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var FormValid;
    (function (FormValid) {
