...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(7), __webpack_require__(9), __webpack_require__(10), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, events_1, replaceHTML_1, Work_1, array_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var input = document.getElementById('input'), result = document.getElementById('result');
    acceptKeys(input, function (v, e) {
        var i = parseInt(input.value);
        if (typeof i === 'number') {
        }
    });
    var d = '<li class="{{$.index === _.state ? "active" : ""}}">{{$[$.index]}}</li>', ff = replaceHTML_1._replaceHTML(d), value = (function (s) { return s.reduce(function (r, v, i) { return (r[i] = v, r); }, { index: -1 }); })(Work_1.Work.$state);
    array_1._range(0, 7, function (v) {
        value.index = v;
