...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(4), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, array_1, selector_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function parsing(ele, mapping) {
        if (ele.nodeType !== 1)
            return;
        var childs = selector_1.getElementChilds(ele), templateName = ele.getAttribute('data-template'), isTemplate = templateName != null;
        if (isTemplate && childs.length > 1)
            throw new Error('[data-template]는 반드시 하나의 엘리먼트만 자식으로 가질 수 있습니다.');
        array_1._forEach(childs, function (e, i) {
            parsing(e, mapping);
        });
        if (isTemplate) {
            var child_1 = childs[0];
            ele.removeChild(child_1);
            mapping.addTemplate(templateName, function () { return child_1.cloneNode(true); });
        }
    }
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
