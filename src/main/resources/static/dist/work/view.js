...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(8), __webpack_require__(3), __webpack_require__(6), __webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, NameMap_1, arrays_1, core_1, access_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Events) {
        ...
        Events.map = map;
        function acceptKeys(target, handler) {
            var key = null;
        ...
        Events.eventProperty = eventProperty;
        function dataEvent(element, type, // 이벤트 타입
        attr, // 이벤트
        getObj, // directive에 전달될 데이터
        dispatcher, // loop 핸들러
        directive) {
            return new Events(element, type, function (e) {
                var target = e.target, dir = directive[target.getAttribute(attr)];
                if (dir) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(5), __webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, array_1, access_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(5), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, events_1, array_1, dom_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(15)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, Imager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(10)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, events_1, position_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(9), __webpack_require__(2), __webpack_require__(11), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, calendar_1, events_1, Mapping_1, dom_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var $render = Mapping_1.Mapping.$render;
    ...
    var Screen = /** @class */ (function () {
        function Screen(element, path) {
            ...
            this.wheelEvent = new events_1.EventsGroup()
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(25), __webpack_require__(9), __webpack_require__(6), __webpack_require__(7), __webpack_require__(26), __webpack_require__(16), __webpack_require__(5), __webpack_require__(4), __webpack_require__(2), __webpack_require__(0), __webpack_require__(24), __webpack_require__(27), __webpack_require__(28), __webpack_require__(13), __webpack_require__(10), __webpack_require__(29), __webpack_require__(14), __webpack_require__(17), __webpack_require__(11), __webpack_require__(31), __webpack_require__(32)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, Work_1, calendar_1, core_1, format_1, FileUpload_1, Screen_1, array_1, dom_1, events_1, access_1, FormEvent_1, _recieveFiles_1, replaceHTML_1, DragSort_1, position_1, patseImage_1, ImageScreen_1, ViewForm_1, Mapping_1, ComfirmBox_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var eventProperty = events_1.Events.eventProperty;
    ...
    function $init($uuid, $path, $work) {
        var body = document.body, element = document.getElementById('view'), $uploadProgress = new FileUpload_1.FileUpload(document.getElementById('file-upload')), $screen = new Screen_1.Screen(document.getElementById('screen'), $path), $imageScreen = new ImageScreen_1.ImageScreen(document.getElementById('image-screen')), $confirm = new ComfirmBox_1.ConfirmBox(document.getElementById('confirm-box')), $mapping, 
        /*
        ...
        eventRegister = {
            $attach: function (e) {
                var _this = this;
                array_1._forEach(e.querySelectorAll('[data-event-register]'), function (e) {
                    _this[e.getAttribute('data-event-register')](e);
                });
                return e;
            },
            // **************** 이벤트 종류
            ...
            itemSort: function (mapper) {
                var r_tr = /tr/i, $form = $viewForms[mapper.getAttribute('data-mapper')], sort = new DragSort_1.DragSort(), tbody = mapper.getElementsByTagName('tbody')[0], target, index, items, sortHandler = function (ele, moveUp) {
                    ...
                    if (index !== idx) {
                        var values_1 = array_1._move(items, index, idx);
                        Work_1.WorkItem.priority(values_1.map(function (v) { return v.id; })).then(function (v) {
                            $work.items = values_1;
        ...
        $viewForms = (function (list) {
            ...
            array_1._forEach(list, function (e) {
                $forms[e.getAttribute('data-form')] =
                    new ViewForm_1.ViewForm(eventRegister.$attach(createHTML(e.innerText)));
            });
            return $forms;
        ...
        $$templates = (function (list) {
            ...
            return result;
        })(document.head.querySelectorAll('[data-template]')), $each = (function (list) {
            var $templates = {};
            array_1._forEach(list, function (e) {
                var name = e.getAttribute('data-each'), html = createHTML(e.innerText);
                $templates[name] = function () { return html.cloneNode(true); };
            });
            return $templates;
        })(document.querySelectorAll('script[data-each]')), fileTo = function (file) { return ({ name: file.name, data: file }); }, blobTo = function (blob) {
            ...
            array_1._reduce(files, function (promise, file, i) {
                return promise.then(function () {
                    return Work_1.WorkFile
                        .uploadFile('files', file, $uploadProgress.start(file.name, i))
        ...
        $directive = {
            ...
            refThumb: function (ele, v) {
                ...
                if (v.content_type.indexOf('image') !== -1) {
                    ...
                    image_1.src = $path + v.getSaveName();
                }
                // ② 일반 파일
                else {
        ...
        CURD = {
            ...
            memo: {
                create: function (data, obj) {
                    ...
                    return Work_1.WorkMemo.save(obj, memo)
                        .then(function (memo) { return obj.addMemo(memo); });
                },
                update: function (data, own) {
                    console.log(data);
                    data['id'] = own.id;
            ...
            items: {
                ...
                create: function (obj, work) {
                    ...
                    return Work_1.WorkItem.save(new Work_1.WorkItem(work, obj), work.id);
                },
        ...
        // ************************************ Start ************************************ //
        $mapping = new Mapping_1.Mapping($work, $directive, $each);
        ...
        var $dataEvent = {
            ...
            confirm: function (obj) {
                var name = obj.name, mapper = obj.mapper, forms = $viewForms[name], element = forms.element;
                // 수정
        ...
        //************************************** ▼ Events ▼ **************************************//
        dataEvent(body, 'click', 'data-event', EventObject.$dispatcher, function (t, o) {
            var p;
            eventProperty(t, o);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, events_1, dom_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var FormEvent;
    (function (FormEvent) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(6), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, format_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var datetime = format_1.Formats.datetime;
    function $get(url) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, array_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(0), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, access_1, format_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var primitive = access_1.Access.primitive;
    ...
    function $opt(str) {
        if (!str)
            return dummy;
        var _a = str.split(' : '), d = _a[0], o = _a[1];
        return [d, o ? primitive(o) : undefined];
    }
    // [create] ==> func(data, directive)
    function createExp(str) {
        var _a = str.split(' | '), _prop = _a[0], _dir = _a[1], prop = _prop[0] === '_' ? _prop : '_.' + _prop, _b = $opt(_dir), dir = _b[0], opt = _b[1], func = new Function('_', 'return _ == null ? null : (' + prop + ');');
        return function (data, directive) {
            var v = func(data);
            if (directive[dir])
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(12), __webpack_require__(30), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, events_1, _noop_1, util_1, array_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, events_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ConfirmBox = /** @class */ (function () {
        ...
        ConfirmBox.prototype.on = function (e, handler) {
            var element = this.element;
            e['__skip'] = true;
            if (this.handler)
                this.handler(false);
            this.handler = handler;
            element.setAttribute('style', 'top: ' + e.pageY + 'px; left: ' + e.pageX + 'px;');
