 ...
 *
 */
export class _MediaContainer<T extends MediaData> extends Mapping {
    ...
    constructor(public element: HTMLElement) {
        ...
        let $self = this,
            wheelEventHandler = (e: MouseEvent) => {
         ...
         */
        this.addDirective({
            image(this: _MediaContainer<any>, ele: HTMLElement, data: MediaData, _df, mapping: string) {
